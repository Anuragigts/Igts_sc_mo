            ...
            <div class="panel-body">
               ...
               <form role="form" data-parsley-validate="" novalidate="" class="mb-lg" method="post" action="">
                  <div class="form-group has-feedback">
                     <input id="exampleInputEmail1" name="login_email" type="email" placeholder="Email-Id (or) Mobile No."  required class="form-control email" value="<?= set_value("login_email");?>">
               ...
               <div class="row">
                    <div  class="col-xs-6">
                        <div class="text-center"><a href="<?= base_url();?>forgot_password" class=" btn btn-small btn-default">Forgot your password?</a></div>
                    </div>
                    <div class="col-xs-6">
                     <div class="text-center"><a href="<?php echo base_url()?>register" class="btn btn-small btn-default">New User</a></div>
                    </div>
                 </div>
