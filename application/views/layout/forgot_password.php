         ...
         <div class="panel panel-dark panel-flat">
            ...
            <div class="panel-body">
               ...
               <form role="form" method="post" action="" novalidate="true">
                  ...
                  <input type="submit" class="btn btn-danger btn-block" value="Submit" name="forgot_password"><br>
                  <div class="text-center">
                  <a href="<?php echo base_url();?>"  class="btn btn-small btn-default">Have An Account !</a>
                  </div>
               </form>
            </div>
         </div>
